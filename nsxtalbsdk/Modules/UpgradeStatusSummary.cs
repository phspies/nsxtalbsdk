...
namespace nsxtalbsdk.Modules
{
    public class UpgradeStatusSummary
    {
        ...
        public UpgradeStatusSummary(RestClient Client, List<RestResponseCookie> _sessionCookies, JsonSerializerSettings _defaultSerializationSettings, CancellationToken _cancellationToken, int _timeout, int _retry, string _defaultXAviVerion)
        {
            restClient = Client;
        ...
        public async Task<NSXTALBUpgradeStatusSummaryApiResponseType> GetUpgradestatusinfo(string? Name = null, string? RefersTo = null, string? ReferredBy = null, string? Fields = null, bool? IncludeName = null, bool? SkipDefault = null, string? JoinSubresources = null, string? XAviTenant = null, string? XAviTenantUUID = null, string? XCsrftoken = null, string? XAviVersion = null)
        {
            ...
            IRestResponse<NSXTALBUpgradeStatusSummaryApiResponseType> response = await restClient.ExecuteTaskAsyncWithPolicy<NSXTALBUpgradeStatusSummaryApiResponseType>(request, cancellationToken, timeout, retry);
        ...
        public async Task<NSXTALBUpgradeStatusSummaryType> PostUpgradestatusinfo(NSXTALBUpgradeStatusSummaryType Body, string? XAviTenant = null, string? XAviTenantUUID = null, string? XCsrftoken = null, string? XAviVersion = null)
        {
            ...
            request.AddParameter("sessionid", sessionCookies.Find(x => x.Name == "sessionid"), ParameterType.Cookie);
            request.AddHeader("Referer", restClient.BaseUrl.AbsoluteUri.ToString());
            IRestResponse<NSXTALBUpgradeStatusSummaryType> response = await restClient.ExecuteTaskAsyncWithPolicy<NSXTALBUpgradeStatusSummaryType>(request, cancellationToken, timeout, retry);
            if (response.StatusCode != HttpStatusCode.OK)
			{
        ...
        public async Task<NSXTALBUpgradeStatusSummaryType> GetUpgradestatusinfoUuid(string Uuid, string? Name = null, string? XAviTenant = null, string? XAviTenantUUID = null, string? XCsrftoken = null, string? Fields = null, bool? IncludeName = null, bool? SkipDefault = null, string? JoinSubresources = null, string? XAviVersion = null)
        {
        ...
        public async Task<NSXTALBUpgradeStatusSummaryType> PutUpgradestatusinfoUuid(NSXTALBUpgradeStatusSummaryType Body, string Uuid, string? Name = null, string? XAviTenant = null, string? XAviTenantUUID = null, string? XCsrftoken = null, string? XAviVersion = null)
        {
        ...
        public async Task<NSXTALBUpgradeStatusSummaryType> PatchUpgradestatusinfoUuid(NSXTALBUpgradeStatusSummaryType Body, string Uuid, string? Name = null, string? XAviTenant = null, string? XAviTenantUUID = null, string? XCsrftoken = null, string? XAviVersion = null)
        {
