...
namespace nsxtalbsdk.Modules
{
    public class UpgradeStatusInfo
    {
        ...
        public UpgradeStatusInfo(RestClient Client, JsonSerializerSettings DefaultSerializationSettings, CancellationToken cancellationToken = default(CancellationToken), int timeout, int retry)
        {
            restClient = Client;
