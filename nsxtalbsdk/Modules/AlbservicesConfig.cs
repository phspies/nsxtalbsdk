...
namespace nsxtalbsdk.Modules
{
    public class AlbservicesConfig
    {
        ...
        public AlbservicesConfig(RestClient Client, JsonSerializerSettings DefaultSerializationSettings, CancellationToken cancellationToken = default(CancellationToken), int timeout, int retry)
        {
            restClient = Client;
