...
namespace nsxtalbsdk.Modules
{
    public class ControllerPortalRegistration
    {
        ...
        int timeout;
        int retry;
        public ControllerPortalRegistration(RestClient Client, JsonSerializerSettings DefaultSerializationSettings, CancellationToken _cancellationToken, int _timeout, int _retry)
        {
            restClient = Client;
