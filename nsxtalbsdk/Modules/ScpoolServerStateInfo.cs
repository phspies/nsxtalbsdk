...
namespace nsxtalbsdk.Modules
{
    public class ScpoolServerStateInfo
    {
        ...
        public ScpoolServerStateInfo(RestClient Client, JsonSerializerSettings DefaultSerializationSettings, CancellationToken cancellationToken = default(CancellationToken), int timeout, int retry)
        {
            restClient = Client;
