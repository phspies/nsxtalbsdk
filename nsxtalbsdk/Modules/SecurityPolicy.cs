...
namespace nsxtalbsdk.Modules
{
    public class SecurityPolicy
    {
        ...
        int timeout;
        int retry;
        public SecurityPolicy(RestClient Client, JsonSerializerSettings DefaultSerializationSettings, CancellationToken _cancellationToken, int _timeout, int _retry)
        {
            restClient = Client;
