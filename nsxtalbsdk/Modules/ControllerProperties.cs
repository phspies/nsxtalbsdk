...
namespace nsxtalbsdk.Modules
{
    public class ControllerProperties
    {
        ...
        public ControllerProperties(RestClient Client, JsonSerializerSettings DefaultSerializationSettings)
        {
            restClient = Client;
            defaultSerializationSettings = DefaultSerializationSettings;
        }
        public NSXTALBControllerPropertiesType GetControllerproperties(string XAviVersion, string? Name = null, string? RefersTo = null, string? ReferredBy = null, string? Fields = null, bool? IncludeName = null, bool? SkipDefault = null, string? JoinSubresources = null, string? XAviTenant = null, string? XAviTenantUUID = null, string? XCsrftoken = null)
        {
        ...
        public NSXTALBControllerPropertiesType PutControllerproperties(string XAviVersion, NSXTALBControllerPropertiesType Body, string? Name = null, string? XAviTenant = null, string? XAviTenantUUID = null, string? XCsrftoken = null)
        {
            if (XAviVersion == null) { throw new ArgumentNullException("XAviVersion cannot be null"); }
        ...
        public NSXTALBControllerPropertiesType PatchControllerproperties(string XAviVersion, NSXTALBControllerPropertiesType Body, string? Name = null, string? XAviTenant = null, string? XAviTenantUUID = null, string? XCsrftoken = null)
        {
            if (XAviVersion == null) { throw new ArgumentNullException("XAviVersion cannot be null"); }
            if (Body == null) { throw new ArgumentNullException("Body cannot be null"); }
            NSXTALBControllerPropertiesType? returnValue = default(NSXTALBControllerPropertiesType);
