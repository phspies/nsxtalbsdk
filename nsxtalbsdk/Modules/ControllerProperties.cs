...
namespace nsxtalbsdk.Modules
{
    public class ControllerProperties
    {
        ...
        public ControllerProperties(RestClient Client, JsonSerializerSettings DefaultSerializationSettings, CancellationToken cancellationToken = default(CancellationToken), int timeout, int retry)
        {
            restClient = Client;
