...
namespace nsxtalbsdk.Modules
{
    public class ControllerProperties
    {
        ...
        public ControllerProperties(RestClient Client, List<RestResponseCookie> _sessionCookies, JsonSerializerSettings _defaultSerializationSettings, CancellationToken _cancellationToken, int _timeout, int _retry, string _defaultXAviVerion)
        {
            restClient = Client;
