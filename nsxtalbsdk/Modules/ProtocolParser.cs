...
namespace nsxtalbsdk.Modules
{
    public class ProtocolParser
    {
        ...
        int timeout;
        int retry;
        public ProtocolParser(RestClient Client, JsonSerializerSettings DefaultSerializationSettings, CancellationToken _cancellationToken, int _timeout, int _retry)
        {
            restClient = Client;
