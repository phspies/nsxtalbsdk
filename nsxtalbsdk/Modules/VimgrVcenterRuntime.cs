...
namespace nsxtalbsdk.Modules
{
    public class VimgrVcenterRuntime
    {
        ...
        public VimgrVcenterRuntime(RestClient Client, JsonSerializerSettings DefaultSerializationSettings, CancellationToken cancellationToken = default(CancellationToken), int timeout, int retry)
        {
            restClient = Client;
