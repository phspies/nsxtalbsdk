...
namespace nsxtalbsdk.Modules
{
    public class SnmpTrapProfile
    {
        ...
        int timeout;
        int retry;
        public SnmpTrapProfile(RestClient Client, JsonSerializerSettings DefaultSerializationSettings, CancellationToken _cancellationToken, int _timeout, int _retry)
        {
            restClient = Client;
