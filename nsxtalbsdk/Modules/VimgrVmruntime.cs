...
namespace nsxtalbsdk.Modules
{
    public class VimgrVmruntime
    {
        ...
        public VimgrVmruntime(RestClient Client, JsonSerializerSettings DefaultSerializationSettings, CancellationToken cancellationToken = default(CancellationToken), int timeout, int retry)
        {
            restClient = Client;
