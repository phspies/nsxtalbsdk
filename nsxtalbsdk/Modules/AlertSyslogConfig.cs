...
namespace nsxtalbsdk.Modules
{
    public class AlertSyslogConfig
    {
        ...
        public AlertSyslogConfig(RestClient Client, JsonSerializerSettings DefaultSerializationSettings, CancellationToken cancellationToken = default(CancellationToken), int timeout, int retry)
        {
            restClient = Client;
