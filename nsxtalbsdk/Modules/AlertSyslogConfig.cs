...
namespace nsxtalbsdk.Modules
{
    public class AlertSyslogConfig
    {
        ...
        public AlertSyslogConfig(RestClient Client, List<RestResponseCookie> _sessionCookies, CancellationToken _cancellationToken, int _timeout, int _retry, string _defaultXAviVerion)
        {
            restClient = Client;
