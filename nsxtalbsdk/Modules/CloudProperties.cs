...
namespace nsxtalbsdk.Modules
{
    public class CloudProperties
    {
        ...
        public CloudProperties(RestClient Client, JsonSerializerSettings DefaultSerializationSettings, CancellationToken cancellationToken = default(CancellationToken), int timeout, int retry)
        {
            restClient = Client;
