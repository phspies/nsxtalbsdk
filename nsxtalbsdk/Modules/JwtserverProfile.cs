...
namespace nsxtalbsdk.Modules
{
    public class JwtserverProfile
    {
        ...
        int timeout;
        int retry;
        public JwtserverProfile(RestClient Client, JsonSerializerSettings DefaultSerializationSettings, CancellationToken _cancellationToken, int _timeout, int _retry)
        {
            restClient = Client;
