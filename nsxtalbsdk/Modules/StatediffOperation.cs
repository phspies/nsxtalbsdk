...
namespace nsxtalbsdk.Modules
{
    public class StatediffOperation
    {
        ...
        int timeout;
        int retry;
        public StatediffOperation(RestClient Client, JsonSerializerSettings DefaultSerializationSettings, CancellationToken _cancellationToken, int _timeout, int _retry)
        {
            restClient = Client;
