...
namespace nsxtalbsdk.Modules
{
    public class HttppolicySet
    {
        ...
        public HttppolicySet(RestClient Client, List<RestResponseCookie> _sessionCookies, CancellationToken _cancellationToken, int _timeout, int _retry, string _defaultXAviVerion)
        {
            restClient = Client;
