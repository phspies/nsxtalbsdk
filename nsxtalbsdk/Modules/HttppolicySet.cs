...
namespace nsxtalbsdk.Modules
{
    public class HttppolicySet
    {
        ...
        public HttppolicySet(RestClient Client, JsonSerializerSettings DefaultSerializationSettings, CancellationToken cancellationToken = default(CancellationToken), int timeout, int retry)
        {
            restClient = Client;
