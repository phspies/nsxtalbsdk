...
namespace nsxtalbsdk.Modules
{
    public class UserActivity
    {
        ...
        public UserActivity(RestClient Client, JsonSerializerSettings DefaultSerializationSettings, CancellationToken cancellationToken = default(CancellationToken), int timeout, int retry)
        {
            restClient = Client;
