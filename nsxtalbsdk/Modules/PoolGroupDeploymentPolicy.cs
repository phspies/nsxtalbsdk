...
namespace nsxtalbsdk.Modules
{
    public class PoolGroupDeploymentPolicy
    {
        ...
        public PoolGroupDeploymentPolicy(RestClient Client, List<RestResponseCookie> _sessionCookies, CancellationToken _cancellationToken, int _timeout, int _retry, string _defaultXAviVerion)
        {
            restClient = Client;
        ...
        public async Task<NSXTALBPoolGroupDeploymentPolicyType> PostPoolgroupdeploymentpolicyAsync(NSXTALBPoolGroupDeploymentPolicyType Body, string? XAviTenant = null, string? XAviTenantUUID = null, string? XCsrftoken = null, string? XAviVersion = null)
        {
        ...
        public async Task<NSXTALBPoolGroupDeploymentPolicyType> PutPoolgroupdeploymentpolicyUuidAsync(NSXTALBPoolGroupDeploymentPolicyType Body, string Uuid, string? Name = null, string? XAviTenant = null, string? XAviTenantUUID = null, string? XCsrftoken = null, string? XAviVersion = null)
        {
        ...
        public async Task<NSXTALBPoolGroupDeploymentPolicyType> PatchPoolgroupdeploymentpolicyUuidAsync(NSXTALBPoolGroupDeploymentPolicyType Body, string Uuid, string? Name = null, string? XAviTenant = null, string? XAviTenantUUID = null, string? XCsrftoken = null, string? XAviVersion = null)
        {
        ...
        public async Task<string> DeletePoolgroupdeploymentpolicyUuidAsync(string Uuid, string? Name = null, string? XAviTenant = null, string? XAviTenantUUID = null, string? XCsrftoken = null, string? XAviVersion = null)
        {
