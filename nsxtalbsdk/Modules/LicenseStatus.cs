...
namespace nsxtalbsdk.Modules
{
    public class LicenseStatus
    {
        ...
        int timeout;
        int retry;
        public LicenseStatus(RestClient Client, JsonSerializerSettings DefaultSerializationSettings, CancellationToken _cancellationToken, int _timeout, int _retry)
        {
            restClient = Client;
        ...
        public async Task<NSXTALBLicenseStatusType> PostLicensingStatus(string XAviVersion, NSXTALBLicenseStatusType Body, string? XAviTenant = null, string? XAviTenantUUID = null, string? XCsrftoken = null)
        {
            ...
            NSXTALBLicenseStatusType? returnValue = default(NSXTALBLicenseStatusType);
