...
namespace nsxtalbsdk.Modules
{
    public class LicenseStatus
    {
        ...
        public LicenseStatus(RestClient Client, List<Cookie> _sessionCookies, CancellationToken _cancellationToken, int _timeout, int _retry, string _defaultXAviVerion)
        {
            restClient = Client;
