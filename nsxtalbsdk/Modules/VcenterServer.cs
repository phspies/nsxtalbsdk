...
namespace nsxtalbsdk.Modules
{
    public class VcenterServer
    {
        ...
        public VcenterServer(RestClient Client, JsonSerializerSettings DefaultSerializationSettings, CancellationToken cancellationToken = default(CancellationToken), int timeout, int retry)
        {
            restClient = Client;
