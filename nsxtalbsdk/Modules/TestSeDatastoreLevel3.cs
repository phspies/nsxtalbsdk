...
namespace nsxtalbsdk.Modules
{
    public class TestSeDatastoreLevel3
    {
        ...
        int timeout;
        int retry;
        public TestSeDatastoreLevel3(RestClient Client, JsonSerializerSettings DefaultSerializationSettings, CancellationToken _cancellationToken, int _timeout, int _retry)
        {
            restClient = Client;
