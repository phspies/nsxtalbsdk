...
namespace nsxtalbsdk.Modules
{
    public class CustomIpamDnsProfile
    {
        ...
        public CustomIpamDnsProfile(RestClient Client, List<Cookie> _sessionCookies, CancellationToken _cancellationToken, int _timeout, int _retry, string _defaultXAviVerion)
        {
            restClient = Client;
