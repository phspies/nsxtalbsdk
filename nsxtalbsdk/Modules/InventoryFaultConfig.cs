...
namespace nsxtalbsdk.Modules
{
    public class InventoryFaultConfig
    {
        ...
        int timeout;
        int retry;
        public InventoryFaultConfig(RestClient Client, JsonSerializerSettings DefaultSerializationSettings, CancellationToken _cancellationToken, int _timeout, int _retry)
        {
            restClient = Client;
