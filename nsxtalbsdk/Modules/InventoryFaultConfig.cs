...
namespace nsxtalbsdk.Modules
{
    public class InventoryFaultConfig
    {
        ...
        public InventoryFaultConfig(RestClient Client, JsonSerializerSettings DefaultSerializationSettings, CancellationToken cancellationToken = default(CancellationToken), int timeout, int retry)
        {
            restClient = Client;
            defaultSerializationSettings = DefaultSerializationSettings;
        }
        public async Task<NSXTALBInventoryFaultConfigApiResponseType> GetInventoryfaultconfig(string XAviVersion, string? Name = null, string? RefersTo = null, string? ReferredBy = null, string? Fields = null, bool? IncludeName = null, bool? SkipDefault = null, string? JoinSubresources = null, string? XAviTenant = null, string? XAviTenantUUID = null, string? XCsrftoken = null)
        {
            if (XAviVersion == null) { throw new ArgumentNullException("XAviVersion cannot be null"); }
            NSXTALBInventoryFaultConfigApiResponseType? returnValue = default(NSXTALBInventoryFaultConfigApiResponseType);
            ...
            IRestResponse<NSXTALBInventoryFaultConfigApiResponseType> response = await restClient.ExecuteTaskAsyncWithPolicy<NSXTALBInventoryFaultConfigApiResponseType>(request, cancellationToken, timeout, retry);
        ...
        public async Task<NSXTALBInventoryFaultConfigType> PostInventoryfaultconfig(string XAviVersion, NSXTALBInventoryFaultConfigType Body, string? XAviTenant = null, string? XAviTenantUUID = null, string? XCsrftoken = null)
        {
            if (XAviVersion == null) { throw new ArgumentNullException("XAviVersion cannot be null"); }
            if (Body == null) { throw new ArgumentNullException("Body cannot be null"); }
            NSXTALBInventoryFaultConfigType? returnValue = default(NSXTALBInventoryFaultConfigType);
            ...
            IRestResponse<NSXTALBInventoryFaultConfigType> response = await restClient.ExecuteTaskAsyncWithPolicy<NSXTALBInventoryFaultConfigType>(request, cancellationToken, timeout, retry);
            if (response.StatusCode != HttpStatusCode.OK)
			{
        ...
        public async Task<NSXTALBInventoryFaultConfigType> GetInventoryfaultconfigUuid(string XAviVersion, string Uuid, string? Name = null, string? XAviTenant = null, string? XAviTenantUUID = null, string? XCsrftoken = null, string? Fields = null, bool? IncludeName = null, bool? SkipDefault = null, string? JoinSubresources = null)
        {
            if (XAviVersion == null) { throw new ArgumentNullException("XAviVersion cannot be null"); }
        ...
        public async Task<NSXTALBInventoryFaultConfigType> PutInventoryfaultconfigUuid(string XAviVersion, NSXTALBInventoryFaultConfigType Body, string Uuid, string? Name = null, string? XAviTenant = null, string? XAviTenantUUID = null, string? XCsrftoken = null)
        {
            if (XAviVersion == null) { throw new ArgumentNullException("XAviVersion cannot be null"); }
            if (Body == null) { throw new ArgumentNullException("Body cannot be null"); }
            if (Uuid == null) { throw new ArgumentNullException("Uuid cannot be null"); }
        ...
        public async Task<NSXTALBInventoryFaultConfigType> PatchInventoryfaultconfigUuid(string XAviVersion, NSXTALBInventoryFaultConfigType Body, string Uuid, string? Name = null, string? XAviTenant = null, string? XAviTenantUUID = null, string? XCsrftoken = null)
        {
            if (XAviVersion == null) { throw new ArgumentNullException("XAviVersion cannot be null"); }
            if (Body == null) { throw new ArgumentNullException("Body cannot be null"); }
            if (Uuid == null) { throw new ArgumentNullException("Uuid cannot be null"); }
        ...
        public async Task<string> DeleteInventoryfaultconfigUuid(string XAviVersion, string Uuid, string? Name = null, string? XAviTenant = null, string? XAviTenantUUID = null, string? XCsrftoken = null)
        {
            if (XAviVersion == null) { throw new ArgumentNullException("XAviVersion cannot be null"); }
            if (Uuid == null) { throw new ArgumentNullException("Uuid cannot be null"); }
