...
namespace nsxtalbsdk.Modules
{
    public class SecureChannelAvailableLocalIps
    {
        ...
        public SecureChannelAvailableLocalIps(RestClient Client, JsonSerializerSettings DefaultSerializationSettings, CancellationToken cancellationToken = default(CancellationToken), int timeout, int retry)
        {
            restClient = Client;
