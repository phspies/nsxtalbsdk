...
namespace nsxtalbsdk.Modules
{
    public class HardwareSecurityModuleGroup
    {
        ...
        public HardwareSecurityModuleGroup(RestClient Client, JsonSerializerSettings DefaultSerializationSettings, CancellationToken cancellationToken = default(CancellationToken), int timeout, int retry)
        {
            restClient = Client;
