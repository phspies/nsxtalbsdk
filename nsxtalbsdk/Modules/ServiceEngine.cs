...
namespace nsxtalbsdk.Modules
{
    public class ServiceEngine
    {
        ...
        public ServiceEngine(RestClient Client, JsonSerializerSettings DefaultSerializationSettings, CancellationToken cancellationToken = default(CancellationToken), int timeout, int retry)
        {
            restClient = Client;
