...
namespace nsxtalbsdk.Modules
{
    public class BackupConfiguration
    {
        ...
        public BackupConfiguration(RestClient Client, List<Cookie> _sessionCookies, CancellationToken _cancellationToken, int _timeout, int _retry, string _defaultXAviVerion)
        {
            restClient = Client;
