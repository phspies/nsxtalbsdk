...
namespace nsxtalbsdk.Modules
{
    public class BackupConfiguration
    {
        ...
        public BackupConfiguration(RestClient Client, JsonSerializerSettings DefaultSerializationSettings, CancellationToken cancellationToken = default(CancellationToken), int timeout, int retry)
        {
            restClient = Client;
