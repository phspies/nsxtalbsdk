...
namespace nsxtalbsdk.Modules
{
    public class LogControllerMapping
    {
        ...
        int timeout;
        int retry;
        public LogControllerMapping(RestClient Client, JsonSerializerSettings DefaultSerializationSettings, CancellationToken _cancellationToken, int _timeout, int _retry)
        {
            restClient = Client;
