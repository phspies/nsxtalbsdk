...
namespace nsxtalbsdk.Modules
{
    public class NsxtSegmentRuntime
    {
        ...
        int timeout;
        int retry;
        public NsxtSegmentRuntime(RestClient Client, JsonSerializerSettings DefaultSerializationSettings, CancellationToken _cancellationToken, int _timeout, int _retry)
        {
            restClient = Client;
