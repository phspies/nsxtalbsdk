...
namespace nsxtalbsdk.Modules
{
    public class BotIpreputationTypeMapping
    {
        ...
        public BotIpreputationTypeMapping(RestClient Client, RestResponseCookie _sessionCookie, JsonSerializerSettings _defaultSerializationSettings, CancellationToken _cancellationToken, int _timeout, int _retry, string _defaultXAviVerion)
        {
            restClient = Client;
