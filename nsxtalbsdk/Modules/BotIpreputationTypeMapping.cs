...
namespace nsxtalbsdk.Modules
{
    public class BotIpreputationTypeMapping
    {
        ...
        int timeout;
        int retry;
        public BotIpreputationTypeMapping(RestClient Client, JsonSerializerSettings DefaultSerializationSettings, CancellationToken _cancellationToken, int _timeout, int _retry)
        {
            restClient = Client;
