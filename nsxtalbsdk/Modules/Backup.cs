...
namespace nsxtalbsdk.Modules
{
    public class Backup
    {
        ...
        public Backup(RestClient Client, JsonSerializerSettings DefaultSerializationSettings, CancellationToken cancellationToken = default(CancellationToken), int timeout, int retry)
        {
            restClient = Client;
