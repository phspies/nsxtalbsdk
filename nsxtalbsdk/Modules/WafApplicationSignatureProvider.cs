...
namespace nsxtalbsdk.Modules
{
    public class WafApplicationSignatureProvider
    {
        ...
        int timeout;
        int retry;
        public WafApplicationSignatureProvider(RestClient Client, JsonSerializerSettings DefaultSerializationSettings, CancellationToken _cancellationToken, int _timeout, int _retry)
        {
            restClient = Client;
        ...
        public async Task<NSXTALBWafApplicationSignatureProviderApiResponseType> GetWafapplicationsignatureprovider(string XAviVersion, string? Name = null, string? RefersTo = null, string? ReferredBy = null, string? Fields = null, bool? IncludeName = null, bool? SkipDefault = null, string? JoinSubresources = null, string? XAviTenant = null, string? XAviTenantUUID = null, string? XCsrftoken = null)
        {
            if (XAviVersion == null) { throw new ArgumentNullException("XAviVersion cannot be null"); }
            NSXTALBWafApplicationSignatureProviderApiResponseType? returnValue = default(NSXTALBWafApplicationSignatureProviderApiResponseType);
        ...
        public async Task<NSXTALBWafApplicationSignatureProviderType> PostWafapplicationsignatureprovider(string XAviVersion, NSXTALBWafApplicationSignatureProviderType Body, string? XAviTenant = null, string? XAviTenantUUID = null, string? XCsrftoken = null)
        {
            if (XAviVersion == null) { throw new ArgumentNullException("XAviVersion cannot be null"); }
            if (Body == null) { throw new ArgumentNullException("Body cannot be null"); }
            NSXTALBWafApplicationSignatureProviderType? returnValue = default(NSXTALBWafApplicationSignatureProviderType);
        ...
        public async Task<NSXTALBWafApplicationSignatureProviderType> PutWafapplicationsignatureproviderUuid(string XAviVersion, NSXTALBWafApplicationSignatureProviderType Body, string Uuid, string? Name = null, string? XAviTenant = null, string? XAviTenantUUID = null, string? XCsrftoken = null)
        {
            if (XAviVersion == null) { throw new ArgumentNullException("XAviVersion cannot be null"); }
            if (Body == null) { throw new ArgumentNullException("Body cannot be null"); }
            if (Uuid == null) { throw new ArgumentNullException("Uuid cannot be null"); }
        ...
        public async Task<NSXTALBWafApplicationSignatureProviderType> PatchWafapplicationsignatureproviderUuid(string XAviVersion, NSXTALBWafApplicationSignatureProviderType Body, string Uuid, string? Name = null, string? XAviTenant = null, string? XAviTenantUUID = null, string? XCsrftoken = null)
        {
            if (XAviVersion == null) { throw new ArgumentNullException("XAviVersion cannot be null"); }
            if (Body == null) { throw new ArgumentNullException("Body cannot be null"); }
            if (Uuid == null) { throw new ArgumentNullException("Uuid cannot be null"); }
        ...
        public async Task<string> DeleteWafapplicationsignatureproviderUuid(string XAviVersion, string Uuid, string? Name = null, string? XAviTenant = null, string? XAviTenantUUID = null, string? XCsrftoken = null)
        {
            if (XAviVersion == null) { throw new ArgumentNullException("XAviVersion cannot be null"); }
            if (Uuid == null) { throw new ArgumentNullException("Uuid cannot be null"); }
