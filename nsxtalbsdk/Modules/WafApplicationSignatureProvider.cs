...
namespace nsxtalbsdk.Modules
{
    public class WafApplicationSignatureProvider
    {
        ...
        public WafApplicationSignatureProvider(RestClient Client, List<RestResponseCookie> _sessionCookies, JsonSerializerSettings _defaultSerializationSettings, CancellationToken _cancellationToken, int _timeout, int _retry, string _defaultXAviVerion)
        {
            restClient = Client;
        ...
        public async Task<NSXTALBWafApplicationSignatureProviderApiResponseType> GetWafapplicationsignatureprovider(string? Name = null, string? RefersTo = null, string? ReferredBy = null, string? Fields = null, bool? IncludeName = null, bool? SkipDefault = null, string? JoinSubresources = null, string? XAviTenant = null, string? XAviTenantUUID = null, string? XCsrftoken = null, string? XAviVersion = null)
        {
        ...
        public async Task<NSXTALBWafApplicationSignatureProviderType> PostWafapplicationsignatureprovider(NSXTALBWafApplicationSignatureProviderType Body, string? XAviTenant = null, string? XAviTenantUUID = null, string? XCsrftoken = null, string? XAviVersion = null)
        {
        ...
        public async Task<NSXTALBWafApplicationSignatureProviderType> PutWafapplicationsignatureproviderUuid(NSXTALBWafApplicationSignatureProviderType Body, string Uuid, string? Name = null, string? XAviTenant = null, string? XAviTenantUUID = null, string? XCsrftoken = null, string? XAviVersion = null)
        {
        ...
        public async Task<NSXTALBWafApplicationSignatureProviderType> PatchWafapplicationsignatureproviderUuid(NSXTALBWafApplicationSignatureProviderType Body, string Uuid, string? Name = null, string? XAviTenant = null, string? XAviTenantUUID = null, string? XCsrftoken = null, string? XAviVersion = null)
        {
        ...
        public async Task<string> DeleteWafapplicationsignatureproviderUuid(string Uuid, string? Name = null, string? XAviTenant = null, string? XAviTenantUUID = null, string? XCsrftoken = null, string? XAviVersion = null)
        {
