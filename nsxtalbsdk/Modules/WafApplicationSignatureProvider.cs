...
namespace nsxtalbsdk.Modules
{
    public class WafApplicationSignatureProvider
    {
        ...
        public WafApplicationSignatureProvider(RestClient Client, JsonSerializerSettings DefaultSerializationSettings, CancellationToken cancellationToken = default(CancellationToken), int timeout, int retry)
        {
            restClient = Client;
