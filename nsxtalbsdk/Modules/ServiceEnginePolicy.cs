...
namespace nsxtalbsdk.Modules
{
    public class ServiceEnginePolicy
    {
        ...
        public ServiceEnginePolicy(RestClient Client, JsonSerializerSettings DefaultSerializationSettings, CancellationToken cancellationToken = default(CancellationToken), int timeout, int retry)
        {
            restClient = Client;
            defaultSerializationSettings = DefaultSerializationSettings;
        }
        public async Task<NSXTALBServiceEnginePolicyType> PutServiceenginepolicyUuid(string XAviVersion, NSXTALBServiceEnginePolicyType Body, string Uuid, string? Name = null, string? XAviTenant = null, string? XAviTenantUUID = null, string? XCsrftoken = null)
        {
        ...
        public async Task<NSXTALBServiceEnginePolicyType> GetServiceenginepolicyUuid(string XAviVersion, string Uuid, string? Name = null, string? XAviTenant = null, string? XAviTenantUUID = null, string? XCsrftoken = null, string? Fields = null, bool? IncludeName = null, bool? SkipDefault = null, string? JoinSubresources = null)
        {
            if (XAviVersion == null) { throw new ArgumentNullException("XAviVersion cannot be null"); }
            if (Uuid == null) { throw new ArgumentNullException("Uuid cannot be null"); }
            NSXTALBServiceEnginePolicyType? returnValue = default(NSXTALBServiceEnginePolicyType);
        ...
        public async Task<NSXTALBServiceEnginePolicyType> PatchServiceenginepolicyUuid(string XAviVersion, NSXTALBServiceEnginePolicyType Body, string Uuid, string? Name = null, string? XAviTenant = null, string? XAviTenantUUID = null, string? XCsrftoken = null)
        {
            if (XAviVersion == null) { throw new ArgumentNullException("XAviVersion cannot be null"); }
            if (Body == null) { throw new ArgumentNullException("Body cannot be null"); }
            if (Uuid == null) { throw new ArgumentNullException("Uuid cannot be null"); }
        ...
        public async Task<string> DeleteServiceenginepolicyUuid(string XAviVersion, string Uuid, string? Name = null, string? XAviTenant = null, string? XAviTenantUUID = null, string? XCsrftoken = null)
        {
            if (XAviVersion == null) { throw new ArgumentNullException("XAviVersion cannot be null"); }
            if (Uuid == null) { throw new ArgumentNullException("Uuid cannot be null"); }
        ...
        public async Task<NSXTALBServiceEnginePolicyType> PostServiceenginepolicy(string XAviVersion, NSXTALBServiceEnginePolicyType Body, string? XAviTenant = null, string? XAviTenantUUID = null, string? XCsrftoken = null)
        {
            if (XAviVersion == null) { throw new ArgumentNullException("XAviVersion cannot be null"); }
            if (Body == null) { throw new ArgumentNullException("Body cannot be null"); }
            NSXTALBServiceEnginePolicyType? returnValue = default(NSXTALBServiceEnginePolicyType);
        ...
        public async Task<NSXTALBServiceEnginePolicyApiResponseType> GetServiceenginepolicy(string XAviVersion, string? Name = null, string? RefersTo = null, string? ReferredBy = null, string? Fields = null, bool? IncludeName = null, bool? SkipDefault = null, string? JoinSubresources = null, string? XAviTenant = null, string? XAviTenantUUID = null, string? XCsrftoken = null)
        {
            if (XAviVersion == null) { throw new ArgumentNullException("XAviVersion cannot be null"); }
