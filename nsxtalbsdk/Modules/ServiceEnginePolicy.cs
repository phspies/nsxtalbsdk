...
namespace nsxtalbsdk.Modules
{
    public class ServiceEnginePolicy
    {
        ...
        int timeout;
        int retry;
        public ServiceEnginePolicy(RestClient Client, JsonSerializerSettings DefaultSerializationSettings, CancellationToken _cancellationToken, int _timeout, int _retry)
        {
            restClient = Client;
