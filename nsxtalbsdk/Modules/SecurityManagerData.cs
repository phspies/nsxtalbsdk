...
namespace nsxtalbsdk.Modules
{
    public class SecurityManagerData
    {
        ...
        public SecurityManagerData(RestClient Client, JsonSerializerSettings DefaultSerializationSettings, CancellationToken cancellationToken = default(CancellationToken), int timeout, int retry)
        {
            restClient = Client;
