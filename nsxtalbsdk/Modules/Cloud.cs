...
namespace nsxtalbsdk.Modules
{
    public class Cloud
    {
        ...
        public Cloud(RestClient Client, JsonSerializerSettings DefaultSerializationSettings, CancellationToken cancellationToken = default(CancellationToken), int timeout, int retry)
        {
            restClient = Client;
