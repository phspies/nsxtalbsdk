...
namespace nsxtalbsdk.Modules
{
    public class AlbservicesFileUpload
    {
        ...
        int timeout;
        int retry;
        public AlbservicesFileUpload(RestClient Client, JsonSerializerSettings DefaultSerializationSettings, CancellationToken _cancellationToken, int _timeout, int _retry)
        {
            restClient = Client;
