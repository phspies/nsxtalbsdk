...
namespace nsxtalbsdk.Modules
{
    public class AlbservicesFileUpload
    {
        ...
        public AlbservicesFileUpload(RestClient Client, JsonSerializerSettings DefaultSerializationSettings, CancellationToken cancellationToken = default(CancellationToken), int timeout, int retry)
        {
            restClient = Client;
