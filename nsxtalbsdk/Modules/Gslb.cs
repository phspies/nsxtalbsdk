...
namespace nsxtalbsdk.Modules
{
    public class Gslb
    {
        ...
        public Gslb(RestClient Client, JsonSerializerSettings DefaultSerializationSettings, CancellationToken cancellationToken = default(CancellationToken), int timeout, int retry)
        {
            restClient = Client;
