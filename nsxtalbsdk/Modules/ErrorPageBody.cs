...
namespace nsxtalbsdk.Modules
{
    public class ErrorPageBody
    {
        ...
        public ErrorPageBody(RestClient Client, List<RestResponseCookie> _sessionCookies, CancellationToken _cancellationToken, int _timeout, int _retry, string _defaultXAviVerion)
        {
            restClient = Client;
