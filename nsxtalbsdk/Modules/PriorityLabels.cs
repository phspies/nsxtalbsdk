...
namespace nsxtalbsdk.Modules
{
    public class PriorityLabels
    {
        ...
        public PriorityLabels(RestClient Client, List<RestResponseCookie> _sessionCookies, JsonSerializerSettings _defaultSerializationSettings, CancellationToken _cancellationToken, int _timeout, int _retry, string _defaultXAviVerion)
        {
            restClient = Client;
        ...
        public async Task<NSXTALBPriorityLabelsType> PostPrioritylabels(NSXTALBPriorityLabelsType Body, string? XAviTenant = null, string? XAviTenantUUID = null, string? XCsrftoken = null, string? XAviVersion = null)
        {
        ...
        public async Task<NSXTALBPriorityLabelsType> GetPrioritylabelsUuid(string Uuid, string? Name = null, string? XAviTenant = null, string? XAviTenantUUID = null, string? XCsrftoken = null, string? Fields = null, bool? IncludeName = null, bool? SkipDefault = null, string? JoinSubresources = null, string? XAviVersion = null)
        {
        ...
        public async Task<NSXTALBPriorityLabelsType> PutPrioritylabelsUuid(NSXTALBPriorityLabelsType Body, string Uuid, string? Name = null, string? XAviTenant = null, string? XAviTenantUUID = null, string? XCsrftoken = null, string? XAviVersion = null)
        {
        ...
        public async Task<NSXTALBPriorityLabelsType> PatchPrioritylabelsUuid(NSXTALBPriorityLabelsType Body, string Uuid, string? Name = null, string? XAviTenant = null, string? XAviTenantUUID = null, string? XCsrftoken = null, string? XAviVersion = null)
        {
        ...
        public async Task<string> DeletePrioritylabelsUuid(string Uuid, string? Name = null, string? XAviTenant = null, string? XAviTenantUUID = null, string? XCsrftoken = null, string? XAviVersion = null)
        {
