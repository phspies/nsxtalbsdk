...
namespace nsxtalbsdk.Modules
{
    public class PriorityLabels
    {
        ...
        int timeout;
        int retry;
        public PriorityLabels(RestClient Client, JsonSerializerSettings DefaultSerializationSettings, CancellationToken _cancellationToken, int _timeout, int _retry)
        {
            restClient = Client;
