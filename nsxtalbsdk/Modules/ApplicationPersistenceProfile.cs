...
namespace nsxtalbsdk.Modules
{
    public class ApplicationPersistenceProfile
    {
        ...
        public ApplicationPersistenceProfile(RestClient Client, JsonSerializerSettings DefaultSerializationSettings, CancellationToken cancellationToken = default(CancellationToken), int timeout, int retry)
        {
            restClient = Client;
