...
namespace nsxtalbsdk.Modules
{
    public class PortalFileUpload
    {
        ...
        public PortalFileUpload(RestClient Client, JsonSerializerSettings DefaultSerializationSettings, CancellationToken cancellationToken = default(CancellationToken), int timeout, int retry)
        {
            restClient = Client;
