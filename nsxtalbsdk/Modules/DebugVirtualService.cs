...
namespace nsxtalbsdk.Modules
{
    public class DebugVirtualService
    {
        ...
        public DebugVirtualService(RestClient Client, JsonSerializerSettings DefaultSerializationSettings, CancellationToken cancellationToken = default(CancellationToken), int timeout, int retry)
        {
            restClient = Client;
