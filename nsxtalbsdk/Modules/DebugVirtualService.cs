...
namespace nsxtalbsdk.Modules
{
    public class DebugVirtualService
    {
        ...
        int timeout;
        int retry;
        public DebugVirtualService(RestClient Client, JsonSerializerSettings DefaultSerializationSettings, CancellationToken _cancellationToken, int _timeout, int _retry)
        {
            restClient = Client;
