...
namespace nsxtalbsdk.Modules
{
    public class DebugServiceEngine
    {
        ...
        int timeout;
        int retry;
        public DebugServiceEngine(RestClient Client, JsonSerializerSettings DefaultSerializationSettings, CancellationToken _cancellationToken, int _timeout, int _retry)
        {
            restClient = Client;
