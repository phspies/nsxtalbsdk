...
namespace nsxtalbsdk.Modules
{
    public class NetworkProfile
    {
        ...
        int timeout;
        int retry;
        public NetworkProfile(RestClient Client, JsonSerializerSettings DefaultSerializationSettings, CancellationToken _cancellationToken, int _timeout, int _retry)
        {
            restClient = Client;
