...
namespace nsxtalbsdk.Modules
{
    public class VimgrHostRuntime
    {
        ...
        public VimgrHostRuntime(RestClient Client, List<RestResponseCookie> _sessionCookies, CancellationToken _cancellationToken, int _timeout, int _retry, string _defaultXAviVerion)
        {
            restClient = Client;
