...
namespace nsxtalbsdk.Modules
{
    public class ServiceEngineGroup
    {
        ...
        public ServiceEngineGroup(RestClient Client, JsonSerializerSettings DefaultSerializationSettings, CancellationToken cancellationToken = default(CancellationToken), int timeout, int retry)
        {
            restClient = Client;
