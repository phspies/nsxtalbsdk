...
namespace nsxtalbsdk.Models
{
    ...
    /// 
    /// </summary>
    public class NSXTALBPortalFileUploadType 
    {
        public NSXTALBPortalFileUploadType()
        {
        }
        /// <summary>
        /// Captures status for file upload. Enum options - SYSERR_SUCCESS, SYSERR_FAILURE, SYSERR_OUT_OF_MEMORY, SYSERR_NO_ENT,
        /// SYSERR_INVAL, SYSERR_ACCESS, SYSERR_FAULT, SYSERR_IO, SYSERR_TIMEOUT, SYSERR_NOT_SUPPORTED, SYSERR_NOT_READY,
        /// SYSERR_UPGRADE_IN_PROGRESS, SYSERR_WARM_START_IN_PROGRESS, SYSERR_TRY_AGAIN, SYSERR_NOT_UPGRADING, SYSERR_PENDING,
        /// SYSERR_EVENT_GEN_FAILURE, SYSERR_CONFIG_PARAM_MISSING, SYSERR_BAD_REQUEST, SYSERR_TEST1, SYSERR_TEST2,
        /// SYSERR_QUEUE_TRANSPORT_FAILURE, SYSERR_QUEUE_RETRY_TASK, SYSERR_DATASTORE_TRANSPORT_FAILURE,
        ...
        /// SYSERR_SVC_COMMON_OBJECT_NOT_IN_CACHED_VIEW, SYSERR_RPC_CANCELED_BY_CLIENT, SYSERR_RPC_TIMED_OUT,
        /// SYSERR_RPC_SEND_FAILED, SYSERR_RPC_CANCELED_BY_TRANSACTION_CLEANUP, SYSERR_NO_MULTICAST_RECEIVERS, SYSERR_RPC_FAILED,
        /// SYSERR_RPC_CONNECT_FAILED, SYSERR_CONTROLLER_NOT_READY, SYSERR_VERSION_MISMATCH, SYSERR_ALREADY_REGISTERED,
        /// SYSERR_SE_GRP_CHANGE_REBOOT, SYSERR_INVALID_METHOD, SYSERR_DESERIALIZATION, SYSERR_SERIALIZATION, SYSERR_ENQUEUE,
        /// SYSERR_DEQUEUE, SYSERR_INVALID_READ_LEVEL, SYSERR_ADD_HM_PHM_OBJECT_NOT_FOUND, SYSERR_CREATE_INVALID_PERSISTENCE_TYPE,
        /// SYSERR_VS_INVALID_METHOD, SYSERR_VS_NOT_PRESENT, SYSERR_VS_INVALID_REQUEST, SYSERR_VS_NOT_ENOUGH_RESOURCES,
        /// SYSERR_VS_SE_NOT_AVAILABLE, SYSERR_VS_VNIC_FAILURE, SYSERR_VS_DELETE_WHILE_STILL_BEING_REFERRED,
        /// SYSERR_INVALID_HEALTH_MONITOR_TYPE, SYSERR_VS_SE_ASSIGNMENT_FAILED, SYSERR_VS_INVALID_OBJECT,
        /// SYSERR_VS_SERVICE_ENGINE_DOWN, SYSERR_VS_RPC_FAILURE, SYSERR_VS_NOT_BOUND, SYSERR_VS_DISABLED, SYSERR_VS_INTERNAL_ERROR,
        /// SYSERR_VS_SCALEOUT_ERROR, SYSERR_VS_SCALEIN_ERROR, SYSERR_VS_MIGRATE_ERROR, SYSERR_VS_MIGRATE_SCALEOUT_ERROR,
        /// SYSERR_VS_MIGRATE_SCALEIN_ERROR, SYSERR_VS_AWAIT_STATIC_SE, SYSERR_VS_MIN_SE_NOT_ASSIGNED,
        /// SYSERR_VS_SE_NOT_AT_CURRENT_VERSION, SYSERR_VS_RUNTIME_ABSENT, SYSERR_VS_STATEDB_ERR,
        ...
        /// SYSERR_SE_MGR_SE_OFFLINE_HB_FAILURE, SYSERR_SE_UPGRADE_IN_PROGRESS, SYSERR_SE_NOT_CONNECTED, SYSERR_RM_RES_UNAVAIL,
        /// SYSERR_RM_RES_UNAVAIL_NOTIFY, SYSERR_RM_RES_NOT_INUSE, SYSERR_RM_CONSUMER_NOT_FOUND, SYSERR_RM_REACHABILITY_FAILED,
        /// SYSERR_RM_RELEASE_SE_UNAVAIL, SYSERR_RM_UNKNOWN_SE_GROUP, SYSERR_RM_NO_SE_FOUND, SYSERR_RM_PARTIAL_SE_FOUND,
        /// SYSERR_RM_AWAIT_VM_CREATE, SYSERR_RM_AWAIT_VNIC_ADD, SYSERR_RM_AWAIT_BOOTUP, SYSERR_RM_RESOURCE_NOT_FOUND,
        /// SYSERR_RM_CANNOT_SPAWN_SE, SYSERR_RM_RES_NOT_NEEDED, SYSERR_RM_RES_INFRA_DELETED, SYSERR_RM_RES_USER_DELETED,
        /// SYSERR_RM_RES_USER_REBOOTED, SYSERR_RM_RES_CRASHED, SYSERR_RM_RES_CONN_LOST, SYSERR_RM_RES_VIP_REACH_LOST,
        /// SYSERR_RM_VS_PROCESSING, SYSERR_RM_VNIC_IP_FAILURE, SYSERR_RM_STATIC_NO_POOL, SYSERR_RM_STATIC_POOL_EXHAUSTED,
        /// SYSERR_RM_VIP_MULT_NETWORKS, SYSERR_RM_SRVR_MULT_NETWORKS, SYSERR_RM_VIP_NO_NETWORK, SYSERR_RM_SRVR_NO_NETWORK,
        /// SYSERR_RM_MAX_PARALLEL_SE_CREATE, SYSERR_RM_MAX_SE_CREATE_ATTEMPTS, SYSERR_RM_MULT_SE_CRASH,
        /// SYSERR_RM_VS_SE_CREATE_IN_PROG, SYSERR_RM_VS_SE_BOOTUP_IN_PROG, SYSERR_RM_VS_SE_VNIC_ADD_IN_PROG,
        /// SYSERR_RM_VS_SE_VNIC_IP_IN_PROG, SYSERR_RM_NO_SUITABLE_HOST, SYSERR_RM_NO_SE_IN_SE_GRP, SYSERR_RM_ALL_SE_IN_SE_GRP_DOWN,
        ...
        /// SYSERR_RM_LICENSE_EXCEEDED_CANNOT_SPAWN_SE, SYSERR_RM_RES_SWTICHOVER_FORCE, SYSERR_RM_RES_USER_DISABLED,
        /// SYSERR_VI_MGR_SEVM_VNIC_SUCCESS, SYSERR_VI_MGR_SEVM_CREATE_FAIL_NO_HW_INFO,
        ...
        /// SYSERR_VI_MGR_SEVM_CREATE_FAIL_OVF_ERROR, SYSERR_VI_MGR_SEVM_CREATE_NO_HOST_VM_NETWORK,
        /// SYSERR_VI_MGR_SEVM_CREATE_FAIL_NO_PROGRESS, SYSERR_VI_MGR_SEVM_CREATE_FAIL_ABORTED, SYSERR_VI_MGR_SEVM_CREATE_FAILURE,
        /// SYSERR_VI_MGR_SEVM_CREATE_FAIL_POWER_ON, SYSERR_VI_MGR_SEVM_VNIC_NO_VM, SYSERR_VI_MGR_SEVM_VNIC_MAC_ADDR_ERROR,
        /// SYSERR_VI_MGR_SEVM_VNIC_FAILURE, SYSERR_VI_MGR_SEVM_VNIC_NO_PG_PORTS, SYSERR_VI_MGR_SEVM_DELETE_FAILURE,
        ...
        /// SYSERR_AUTOSCALE_POLICY_NOT_FOUND, SYSERR_LICENSE_FIELD_NAME_NOT_SET, SYSERR_LICENSE_FILE_NOT_FOUND,
        ...
        /// SYSERR_SEAGENT_OBJ_INACTIVE, SYSERR_SEAGENT_OBJ_AWAITING_DP_PROGRAMMING, SYSERR_SEAGENT_OBJ_ACTIVE,
        /// SYSERR_SEAGENT_OBJ_GRAPHDB_ERROR, SYSERR_SEAGENT_OBJ_DP_ERROR, SYSERR_SEAGENT_OBJ_DISABLED_RULE_POOL,
        /// SYSERR_SEAGENT_EASTWEST_VS_SUBNET_ERROR, SYSERR_SEAGENT_OBJ_NOT_FOUND, SYSERR_SEAGENT_VS_NOT_FOUND,
        /// SYSERR_SEAGENT_VS_VRF_ERROR, SYSERR_SEAGENT_VS_SELIST_LIMIT_ERROR, SYSERR_SEAGENT_VS_SELIST_SE_INTF_ERROR,
        /// SYSERR_SEAGENT_VS_CHILD_PARENT_UUID_MISSING, SYSERR_SEDP_PARENT_VS_NOT_EXIST_FOR_CHILD,
        /// SYSERR_SEAGENT_TENANT_CREATE_FAILED, SYSERR_SEAGENT_TENANT_UPDATE_FAILED, SYSERR_SEAGENT_VS_INTERFACE_ERROR,
        /// SYSERR_SEDP_VNIC_CREATION_FAILURE, SYSERR_SEDP_VNIC_ATTACH_FAILURE, SYSERR_SEDP_VNIC_IF_CREATION_FAILURE,
        /// SYSERR_SEDP_VNIC_START_FAILURE, SYSERR_SEDP_VNIC_NOT_FOUND, SYSERR_SEDP_VNIC_MISMATCH_VRF,
        ...
        /// SYSERR_SEDP_VNIC_VLAN_FILTER_REMOVE_FAILURE, SYSERR_SEDP_VNIC_UNKNOWN_MSG_TYPE, SYSERR_GSLB_INVALID_MTYPE,
        /// SYSERR_GSLB_INVALID_SITE_CREDENTIALS, SYSERR_GSLB_OBJECT_NOT_FOUND, SYSERR_GSLB_INVALID_OPS,
        ...
        /// SYSERR_GSLB_SERVICE_CREATE_FAILED, SYSERR_GSLB_SERVICE_UPDATE_FAILED, SYSERR_DNS_POLICY_CREATE_FAIL,
        ...
        /// SYSERR_NET_PROF_NOT_FOUND, SYSERR_PORTAL_FILE_UPLOAD_IN_PROGRESS, SYSERR_PORTAL_FILE_UPLOAD_SUCCESS,
        /// SYSERR_PORTAL_FILE_UPLOAD_FAILED, SYSERR_PORTAL_FILE_UPLOAD_STARTED, SYSERR_AVI_CLOUD_CASE_ID_MISSING,
        /// SYSERR_AVI_CLOUD_ASSET_ID_MISSING, SYSERR_AVI_CLOUD_AUTH_FAILURE, SYSERR_AVI_CLOUD_INTERNAL_ERROR,
        /// SYSERR_AVI_CLOUD_DISCONNECTED, SYSERR_AVI_CLOUD_DEREGISTERED, SYSERR_AVI_CLOUD_CANNOT_READ_RESP,
        /// SYSERR_AVI_CLOUD_CONTROLLER_ALREADY_REGISTERED, SYSERR_AVI_CLOUD_REG_SESSION_NOT_SET, SYSERR_AVI_CLOUD_CLIENT_TIME_OUT,
        /// SYSERR_AVI_CLOUD_CONN_REFUSED, SYSERR_PORTAL_CONNECTOR_HTTP_CLIENT_ERROR, SYSERR_AVI_CLOUD_RESOURCE_NOT_FOUND,
        /// SYSERR_AVI_CLOUD_QUERY_PARAM_VALUE_NOT_SUPPORTED, SYSERR_AVI_CLOUD_QUERY_PARAM_NOT_SUPPORTED,
        /// SYSERR_PORTAL_FILE_UPLOAD_CONFLICT, SYSERR_PORTAL_CONNECTOR_INTERNAL_ERROR, SYSERR_AVI_CLOUD_PROXY_AUTH_FAILURE,
        /// SYSERR_AVI_CLOUD_LOGIN_URL_NOT_FOUND, SYSERR_AVI_CLOUD_LOGIN_REQ_FAILED, SYSERR_UPGRADE_SYSTEM_STARTED,
        ...
        /// SYSERR_ROLLBACKPATCH_SEGROUP_STARTED, SYSERR_UPGRADE_OPS_VS_DISRUPTION_WARNINGS, SYSERR_UPGRADE_OPS_IN_PROGRESS,
        ...
        /// SYSERR_UPGRADE_OPS_CHECK_SE_DISK_SPACE, SYSERR_UPGRADE_OPS_CHECK_VS_DISRUPUTION,
        /// SYSERR_UPGRADE_OPS_CHECK_ROLLBACK_BASICS, SYSERR_UPGRADE_OPS_CHECK_CONTROLLER_VERSION_ROLLBACK,
        /// SYSERR_UPGRADE_OPS_CHECK_SE_VERSION_ROLLBACK, SYSERR_UPGRADE_OPS_CHECK_CONTROLLER_ROLLBACK,
        /// SYSERR_UPGRADE_OPS_CHECK_SE_GROUP_ROLLBACK, SYSERR_UPGRADE_OPS_CHECK_SYSTEM_ROLLBACK,
        /// SYSERR_UPGRADE_OPS_CHECK_IMAGE_VERSION, SYSERR_UPGRADE_OPS_CHECK_DOCKER_DISK_SPACE,
        ...
        /// SYSERR_MC_UPGRADE_LICENSE_ERR, SYSERR_MC_UPGRADE_CLUSTER_NOT_READY, SYSERR_MC_DISK_INSUFFICIENT_ERR,
        ...
        /// SYSERR_CLIENT_AUTH_PROFILE_NOT_FOUND, SYSERR_CLIENT_AUTH_PROFILE_NULL, SYSERR_COMPR_FLTR_UNKNOWN_LEVEL,
        /// SYSERR_COMPR_MIME_TYPE_NOT_INITED, SYSERR_IPADDRGRP_NOT_FOUND, SYSERR_DUPLICATE_UPSTREAM,
        /// SYSERR_UPSTREAM_COMPLEX_COMPILATION_FAILED, SYSERR_UPSTREAM_INIT_NO_SERVERS, SYSERR_UPSTREAM_INVALID_ADDRESS,
        /// SYSERR_UPSTREAM_INVALID_HOST, SYSERR_UPSTREAM_WITHOUT_PORT, SYSERR_UPSTREAM_INVALID_PARAMETER,
        /// SYSERR_UPSTREAM_INVALID_VALUE, SYSERR_UPSTREAM_LB_NO_PEERS, SYSERR_UPSTREAM_LB_NULL_CONF,
        /// SYSERR_UPSTREAM_PARSE_URL_FAILED, SYSERR_UPSTREAM_UNSUPPORTED_PARAMETER, SYSERR_PAA_NO_OBJECT,
        /// SYSERR_PAA_FILESYSTEM_CREATE_FAIL, SYSERR_PAA_CACHE_CREATE_FAIL, SYSERR_POLICY_HASH_REMOVE,
        /// SYSERR_POLICY_V4_TREE_CREATION, SYSERR_POLICY_V6_TREE_CREATION, SYSERR_POLICY_APPLOG_PROV,
        /// SYSERR_POLICY_CLIENT_IP_GROUP_UUID, SYSERR_POLICY_PATH_MATCH_GROUP_UUID, SYSERR_POLICY_QUERY_MATCH_GROUP_UUID,
        /// SYSERR_POLICY_UNKOWN_MATCH_ACTION, SYSERR_POLICY_INVALID_HDR_ACTIONS, SYSERR_POLICY_RWH_COOKIE_OPER,
        /// SYSERR_POLICY_HASH_INSERT, SYSERR_SSL_CERT_NOT_PRESENT, SYSERR_SSL_CERT_KEY_NOT_PRESENT, SYSERR_SSL_CTX_CREATION_ERR,
        /// SYSERR_SSL_CERT_READ_FAILURE, SYSERR_SSL_CERT_LOAD_TO_CTX, SYSERR_SSL_CERT_IDX_TO_CTX, SYSERR_SSL_KEY_LOAD_TO_CTX,
        /// SYSERR_SSL_CERT_CHAIN_READ_FAILURE, SYSERR_SSL_CERT_CHAIN_ADD_FAILURE, SYSERR_SSL_KEY_READ_FAILURE,
        /// SYSERR_SSL_CERTIFICATE_AND_KEY_MISMATCH, SYSERR_SSL_CIPHER_LIST_NOT_SET, SYSERR_SSL_CIPHER_SUITES_NOT_SET,
        /// SYSERR_SSL_PKI_CLIENT_CA, SYSERR_SSL_DHPARAM_FAILURE, SYSERR_SSL_ECDH_FAILURE, SYSERR_SSL_HOSTMAP_FAILURE,
        /// SYSERR_SSL_SESSION_CACHE_INIT, SYSERR_SSL_SESSION_TIX_KEYS_INIT, SYSERR_SSL_PKI_CRL. Field introduced in 18.2.6.
        /// </summary>
        ...
        /// </summary>
        [JsonProperty(PropertyName = "s3_directory")]
