...
namespace nsxtalbsdk.Models
{
    ...
    /// 
    /// </summary>
    public class NSXTALBAutoScaleLaunchConfigType
    {
        /// <summary>
        ...
        /// <summary>
        /// If set to True, ServerAutoscalePolicy will use the autoscaling group (external_autoscaling_groups) from Pool to perform
        /// scale up and scale down. Pool should have single autoscaling group configured. Field introduced in 17.2.3.
        /// </summary>
