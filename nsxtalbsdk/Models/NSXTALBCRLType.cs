...
namespace nsxtalbsdk.Models
{
    ...
    public class NSXTALBCRLType 
    {
        ...
        /// <summary>
        /// URL of a server that issues the Certificate Revocation list. If this is configured, CRL will be periodically downloaded
        /// either based on the configured update interval or the next update interval in the CRL. CRL itself is stored in the body.
        /// </summary>
        ...
        /// <summary>
        /// Interval in minutes to check for CRL update. If not specified, interval will be 1 day. Allowed values are 30-525600.
        /// Unit is MIN.
        /// </summary>
