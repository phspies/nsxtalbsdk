...
namespace nsxtalbsdk.Models
{
    ...
    public class NSXTALBAlertRuleEventType 
    {
        ...
        public IList<NSXTALBEventDetailsFilterType> EventDetails { get; set; }
        /// <summary>
        /// When the selected event occurs, trigger this alert. Enum options - VINFRA_DISC_DC, VINFRA_DISC_HOST,
        /// VINFRA_DISC_CLUSTER, VINFRA_DISC_VM, VINFRA_DISC_NW, MGMT_NW_NAME_CHANGED, DISCOVERY_DATACENTER_DEL, VM_ADDED,
        /// VM_REMOVED, VINFRA_DISC_COMPLETE, VCENTER_ADDRESS_ERROR, SE_GROUP_CLUSTER_DEL, SE_GROUP_MGMT_NW_DEL, MGMT_NW_DEL,
        /// VCENTER_BAD_CREDENTIALS, ESX_HOST_UNREACHABLE, SERVER_DELETED, SE_GROUP_HOST_DEL, VINFRA_DISC_FAILURE,
        /// ESX_HOST_POWERED_DOWN, VCENTER_VERSION_NOT_SUPPORTED, VCENTER_CONNECTIVITY_FAIL, VCENTER_CONNECTIVITY_SUCCESS,
        /// VCENTER_ACCESS_SLOW, VCENTER_USER_ROLE_CHANGE, VCENTER_NETWQRK_OBJECT_LIMIT_REACHED, SE_FATAL_ERROR,
        /// SE_HEARTBEAT_FAILURE, SE_MARKED_DOWN, SE_VM_DELETED, SE_VM_PURGED, SE_UP, SE_POWERED_DOWN, SE_REBOOTED,
        ...
        /// </summary>
        [JsonProperty(PropertyName = "not_cond")]
        public bool? NotCond { get; set; }
    }
}
