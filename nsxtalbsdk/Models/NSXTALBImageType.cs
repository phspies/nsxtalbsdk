...
namespace nsxtalbsdk.Models
{
    ...
    /// 
    /// </summary>
    public class NSXTALBImageType 
    {
        public NSXTALBImageType()
        {
        }
        /// <summary>
        ...
        /// </summary>
        [JsonProperty(PropertyName = "cloud_info_values")]
        public IList<NSXTALBImageCloudDataType> CloudInfoValues { get; set; }
        /// <summary>
        /// Controller package details. Field introduced in 18.2.6.
        /// </summary>
        [JsonProperty(PropertyName = "controller_info")]
        public NSXTALBPackageDetailsType ControllerInfo { get; set; }
        /// <summary>
        /// Mandatory Controller patch name that is applied along with this base image. Field introduced in 18.2.10, 20.1.1.
        /// </summary>
        [JsonProperty(PropertyName = "controller_patch_name")]
        public string? ControllerPatchName { get; set; }
        /// <summary>
        /// It references the controller-patch associated with the Uber image. It is a reference to an object of type Image. Field
        /// introduced in 18.2.8, 20.1.1.
        /// </summary>
        [JsonProperty(PropertyName = "controller_patch_ref")]
        public string? ControllerPatchRef { get; set; }
        /// <summary>
        ...
        public IList<NSXTALBImageEventMapType> Events { get; set; }
        /// <summary>
        /// Status of the image. Field introduced in 21.1.3.
        /// </summary>
        [JsonProperty(PropertyName = "img_state")]
        public NSXTALBImageUploadOpsStatusType ImgState { get; set; }
        /// <summary>
        /// This field describes the api migration related information. Field introduced in 18.2.6.
        /// </summary>
        [JsonProperty(PropertyName = "migrations")]
        public NSXTALBSupportedMigrationsType Migrations { get; set; }
        /// <summary>
        ...
        /// <summary>
        /// Image upload progress which holds value between 0-100. Allowed values are 0-100. Field introduced in 21.1.3. Unit is
        /// PERCENT.
        /// </summary>
        ...
        /// </summary>
        [JsonProperty(PropertyName = "se_info")]
        public NSXTALBPackageDetailsType SeInfo { get; set; }
        /// <summary>
        /// Mandatory ServiceEngine patch name that is applied along with this base image. Field introduced in 18.2.10, 20.1.1.
        /// </summary>
        [JsonProperty(PropertyName = "se_patch_name")]
        public string? SePatchName { get; set; }
        /// <summary>
        /// It references the Service Engine patch associated with the Uber Image. It is a reference to an object of type Image.
        /// Field introduced in 18.2.8, 20.1.1.
        /// </summary>
        [JsonProperty(PropertyName = "se_patch_ref")]
        public string? SePatchRef { get; set; }
        /// <summary>
        ...
        /// <summary>
        /// Status to check if the image is present. Enum options - SYSERR_SUCCESS, SYSERR_FAILURE, SYSERR_OUT_OF_MEMORY,
        /// SYSERR_NO_ENT, SYSERR_INVAL, SYSERR_ACCESS, SYSERR_FAULT, SYSERR_IO, SYSERR_TIMEOUT, SYSERR_NOT_SUPPORTED,
        /// SYSERR_NOT_READY, SYSERR_UPGRADE_IN_PROGRESS, SYSERR_WARM_START_IN_PROGRESS, SYSERR_TRY_AGAIN, SYSERR_NOT_UPGRADING,
        /// SYSERR_PENDING, SYSERR_EVENT_GEN_FAILURE, SYSERR_CONFIG_PARAM_MISSING, SYSERR_RANGE, SYSERR_BAD_REQUEST, SYSERR_TEST1,
        /// SYSERR_TEST2, SYSERR_QUEUE_TRANSPORT_FAILURE, SYSERR_QUEUE_RETRY_TASK, SYSERR_QUEUE_FULL,
        /// SYSERR_DATASTORE_TRANSPORT_FAILURE, SYSERR_DATASTORE_UNKNOWN_FAILURE, SYSERR_DATASTORE_OBJECT_DOES_NOT_EXIST,
        /// SYSERR_DATASTORE_REFERENCE_DOES_NOT_EXIST, SYSERR_DATASTORE_DB_LOCKED, SYSERR_DATASTORE_LOCK_FAILURE,
        /// SYSERR_DATASTORE_TBL_NOT_EXIST, SYSERR_DATABASE_OBJECT_DOES_NOT_EXIST, SYSERR_SVC_COMMON_OBJECT_NOT_IN_CACHED_VIEW,
        /// SYSERR_RPC_CANCELED_BY_CLIENT, SYSERR_RPC_TIMED_OUT, SYSERR_RPC_SEND_FAILED, SYSERR_RPC_CANCELED_BY_TRANSACTION_CLEANUP,
        /// SYSERR_NO_MULTICAST_RECEIVERS, SYSERR_RPC_FAILED, SYSERR_RPC_CONNECT_FAILED, SYSERR_CONTROLLER_NOT_READY,
        /// SYSERR_VERSION_MISMATCH, SYSERR_ALREADY_REGISTERED, SYSERR_SE_GRP_CHANGE_REBOOT, SYSERR_INVALID_METHOD,
        /// SYSERR_DESERIALIZATION, SYSERR_SERIALIZATION, SYSERR_ENQUEUE, SYSERR_DEQUEUE, SYSERR_INVALID_READ_LEVEL,
        /// SYSERR_ADD_HM_PHM_OBJECT_NOT_FOUND, SYSERR_CREATE_INVALID_PERSISTENCE_TYPE, SYSERR_VS_INVALID_METHOD,
        /// SYSERR_VS_NOT_PRESENT, SYSERR_VS_INVALID_REQUEST, SYSERR_VS_NOT_ENOUGH_RESOURCES, SYSERR_VS_SE_NOT_AVAILABLE,
        /// SYSERR_VS_VNIC_FAILURE, SYSERR_VS_DELETE_WHILE_STILL_BEING_REFERRED, SYSERR_INVALID_HEALTH_MONITOR_TYPE,
        /// SYSERR_VS_SE_ASSIGNMENT_FAILED, SYSERR_VS_INVALID_OBJECT, SYSERR_VS_SERVICE_ENGINE_DOWN, SYSERR_VS_RPC_FAILURE,
        /// SYSERR_VS_NOT_BOUND, SYSERR_VS_DISABLED, SYSERR_VS_INTERNAL_ERROR, SYSERR_VS_SCALEOUT_ERROR, SYSERR_VS_SCALEIN_ERROR,
        ...
        /// SYSERR_LIC_CONVERT_MALFORMED_PAYLOAD, SYSERR_FILE_CONTENT_DECODE_FAILED, SYSERR_SVC_FAILURE, SYSERR_SVC_SUCCESS. Field
        /// deprecated in 21.1.3. Field introduced in 18.2.6.
        /// </summary>
        ...
        /// <summary>
        /// Type of the image patch/system. Enum options - IMAGE_TYPE_PATCH, IMAGE_TYPE_SYSTEM, IMAGE_TYPE_MUST_CHECK. Field
        ...
        /// </summary>
        [JsonProperty(PropertyName = "uber_bundle")]
        public bool? UberBundle { get; set; }
        /// <summary>
        /// url
        /// </summary>
